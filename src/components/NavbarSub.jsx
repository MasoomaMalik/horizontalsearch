...
const NavbarSub = () => {
  ...
  const HandleFalseCat = () => {
    console.log("enter");
    let tempData = data.filter((x) => x.clicked == false);
    tempData = tempData.map((x) => x.category);

    tempData = [...new Set([...tempData])];
    // console.log("tempData")
    // console.log(tempData)

    return (falseCat = [...tempData]);

    // console.log("falseCat")
    // console.log(falseCat)
  ...
  const HandleTrueCat = () => {
    let tempData = data.filter((x) => x.clicked == true);
    tempData = tempData.map((x) => x.category);
    tempData = [...new Set([...tempData])];
    // console.log("tempData")
  ...
  const HandleClicked = (e) => {
    ...
    trueCat = HandleTrueCat();
    falseCat = HandleFalseCat();
    console.log("trueCathandlekandar");
    console.log(trueCat);
    console.log("FalseCathandlekandar");
    console.log(falseCat);
